...
def checkResponsableTraitement(textToAnalyse):
    ...
    textWhoMustContainTraitement = textToAnalyse[indexToFind:indexToFind + 15]

    while (fuzz.partial_ratio(textWhoMustContainTraitement, "responsable du traitement") < 90):
        textWhoMustContainTraitement = textWhoMustContainTraitement[toFind:]
        indexToFind = textToAnalyse.find(toFind)
        textWhoMustContainTraitement = textToAnalyse[indexToFind:indexToFind + 15]
    ...
    if (fuzz.partial_ratio(textWhoMustContainTraitement, "adresse :") > fuzz.partial_ratio(textWhoMustContainTraitement,
                                                                                           "adresse est")):
        toFind = "adresse :"
        indexToFind = textToAnalyse.find(toFind)
    else:
